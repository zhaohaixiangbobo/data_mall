...
const StatCards: React.FC<StatCardsProps> = ({ summary }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
      ...
      {/* 推广分析 */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col">
        <h3 className="text-lg font-bold text-gray-800 mb-4 text-center border-b border-gray-100 pb-2">数据分析</h3>
        <div className="flex justify-around items-center flex-1">
          <div className="flex flex-col items-center">
            <span className="text-gray-500 text-sm mb-2">数据总量</span>
            <div className="flex items-center">
              ...
              <span className="text-3xl font-bold text-teal-600">{summary.data_total.toLocaleString()}</span>
            </div>
          </div>
          <div className="h-12 w-px bg-gray-200"></div>
          <div className="flex flex-col items-center">
            <span className="text-gray-500 text-sm mb-2">上月新增数据量</span>
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 mr-2">
              ...
              <span className="text-3xl font-bold text-teal-600">{summary.last_month_new_data.toLocaleString()}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col">
        ...
        <div className="flex justify-around items-center flex-1">
          <div className="flex flex-col items-center">
            <span className="text-gray-500 text-sm mb-2">访问总量</span>
            <div className="flex items-center">
              ...
              <span className="text-3xl font-bold text-teal-600">{summary.visits_total.toLocaleString()}</span>
            </div>
          </div>
          <div className="h-12 w-px bg-gray-200"></div>
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center">
              ...
              <span className="text-3xl font-bold text-teal-600">{summary.last_month_visitors.toLocaleString()}</span>
            </div>
          </div>
        </div>
      </div>
